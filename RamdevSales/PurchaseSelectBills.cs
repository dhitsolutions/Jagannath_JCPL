...
namespace RamdevSales
{
    public partial class PurchaseSelectBills : Form
    {
        ...
        public PurchaseSelectBills(TextBox txtnetamt, DataTable dt, object p, string p_2, QPayment qpayment1, string btnname,string billno1)
        {
            InitializeComponent();
        ...
        private void PopupP()
        {
            ...
            {
                DataTable dt1 = con.getdataset("Select * from ref where isactive=1 and accountid='" + p + "' and VchNo='" + billno + "' and (TransactionType='P' or TransactionType='Bank Entry') order by OT1");
                string value = "0";
