...
namespace RamdevSales
{
    public partial class QReceipt : Form
    {
        ...
        public void popup()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                SelectBills popup = new SelectBills(txtnetamt, dt, cmbaccname.SelectedValue, cmbaccname.Text, this, btnsave.Text,txtrecno.Text);
                    ...
                    if (userrights.Rows.Count > 0)
                    {
                        if (userrights.Rows[5]["u"].ToString() == "True")
                        {
                            if (cmbaccname.Text != "")
                            {
                                ...
                                con.execute("UPDATE [dbo].[Ref] SET isactive=0 where [VchNo]='" + txtrecno.Text + "' and [TransactionType]='" + "R" + "'");
                                for (int i = 0; i < dtselectedrow.Rows.Count; i++)
                                {
                                    ...
                                    con.execute("INSERT INTO [dbo].[Ref]([VchNo],[TransactionType],[AccountID],[AccountName],[RefAmount],[DC],[ReceiptNo],[ReceiptDate],[OT7],[OM1],[isactive],[OT1],[OT2],[OT3],[OT4],[OT5],[OT6]) values ('" + txtrecno.Text + "','R','" + dt.Rows[0]["ClientID"].ToString() + "','" + client.Rows[0]["AccountName"].ToString() + "','" + txtnetamt.Text + "','C','" + txtrecno.Text + "','" + Convert.ToDateTime(DTDate.Text).ToString("MM-dd-yyyy") + "','" + txtremark.Text + "','" + strArrayOne[i] + "',1,'" + dtselectedrow.Rows[i]["Date"].ToString() + "','" + dtselectedrow.Rows[i]["BillNO"].ToString() + "','" + dtselectedrow.Rows[i]["BillAmount"].ToString() + "','" + dtselectedrow.Rows[i]["ReceivedAmount"].ToString() + "','" + dtselectedrow.Rows[i]["BalAmount"].ToString() + "','" + dtselectedrow.Rows[i]["Status"].ToString() + "')");
                                }
                                ...
                                strArrayOne = null;
                                con.execute("UPDATE [dbo].[paymentreceipt]SET [date] = '" + Convert.ToDateTime(DTDate.Text).ToString("MM-dd-yyyy") + "',[mode] = '" + cmbpaymode.Text + "',[chqno] = '" + txtchqno.Text + "',[chqdate] = '" + txtchqdate.Text + "',[bankname] = '" + txtbankname.Text + "',[clientid] = '" + cmbaccname.SelectedValue + "',[totalamount] = " + txtamt.Text + ",[discountamt] = " + txtdiscount.Text + ",[netamt] = " + txtnetamt.Text + ",[remarks] = '" + txtremark.Text + "',[OT16]='" + txtf16.Text + "',[OT17]='" + txtf17.Text + "',[OT18]='" + txtf18.Text + "',[OT19]='" + txtf19.Text + "',[OT20]='" + txtf20.Text + "',[OT21]='" + txtf21.Text + "',[OT22]='" + txtf22.Text + "',[OT23]='" + txtf23.Text + "',[OT24]='" + txtf24.Text + "',[OT25]='" + txtf25.Text + "',[OT26]='" + txtf26.Text + "',[OT27]='" + txtf27.Text + "',[OT28]='" + txtf28.Text + "',[OT29]='" + txtf29.Text + "',[OT30]='" + txtf30.Text + "' WHERE [recno] = '" + txtrecno.Text + "' and type='R' and [isactive]=1");
                                con.execute("UPDATE [dbo].[Ledger] SET [Date1]='" + Convert.ToDateTime(DTDate.Text).ToString("MM-dd-yyyy") + "',[AccountID] = '" + cmbaccname.SelectedValue + "',[AccountName]='" + cmbaccname.Text + "' ,[Amount] = '" + Math.Round(Convert.ToDouble(txtnetamt.Text), 2).ToString("########.00") + "',[DC] = 'C',[OT1]='" + cmbpaymode.Text + "',[ShortNarration]='" + txtremark.Text + "' where [VoucherID]= '" + txtrecno.Text + "' and [TranType] = 'Rect'");
            ...
            try
            {
                ...
                if (LVFO.SelectedItems.Count > 0)
                {
                    ...
                    if (dr1 == DialogResult.Yes)
                    {
                        ...
                        Amount = LVFO.Items[LVFO.FocusedItem.Index].SubItems[2].Text;
            ...
            try
            {
                ...
                if (dr1 == DialogResult.Yes)
                {
                    if (LVFO.SelectedItems.Count > 0)
                    {
                        ...
                        {
                            //   string name;
                            con.execute("UPDATE [dbo].[paymentreceipt]SET  [isactive]=0 WHERE [recno] = '" + billno + "' and type='R'");
                            con.execute("UPDATE [dbo].[Ledger] SET [isactive]=0  where [VoucherID]= '" + billno + "' and [TranType] = 'Rect'");
                            con.execute("UPDATE [dbo].[Ref] SET  [isactive]=0 WHERE [VchNo] = '" + billno + "' and TransactionType='R'");
                            LVFO.Items.Clear();
                            DataTable dt1 = con.getdataset("select * from paymentreceipt where isactive='1' and type='R' and [date] = '" + Convert.ToDateTime(DTDate.Text).ToString("MM-dd-yyyy") + "' and [mode] = '" + cmbpaymode.Text + "'");
