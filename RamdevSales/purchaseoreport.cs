...
{
    public partial class purchaseoreport : Form
    {
        ...
        public purchaseoreport()
        {
            InitializeComponent();
        }

        public purchaseoreport(string str)
        {
            try
            {
        ...
        private void purchaseoreport_Load(object sender, EventArgs e)
        {
            //try
            //{
            //    this.StartPosition = FormStartPosition.Manual;
            //    this.Location = new Point(0, 0);
            //    POrderReport crystal = new POrderReport();
            //    BillingPOSPrintDataSet ds = GetData();
